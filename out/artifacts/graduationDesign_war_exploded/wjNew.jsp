...
function cancel(){
	...
	<body leftmargin="8" topmargin="8">
		<form action="ObjectBeanManage?op=addOb" name="fm" method="post">
		<input type="hidden" name="createUser" id="authorName" value="<%=session.getAttribute("userName")%>" />
		<table width="100%" align="center" class="table">
			...
			<table width="100%" align="center" class="table">
				<tr>
					<td height="30" width="150px" align="right">
						主题：
					</td>
					<td style="width: 1273px; ">
						&nbsp;
